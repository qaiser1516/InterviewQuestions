...
namespace InspectionCenterService.Domain
{
    public class InspectionCenterManager : IInspectionCenterManager
    {
        ...
        public ExpandoObject Get(Guid id)
        {
            ...
            var result = CustomSchemaHelper<ExpandoObject>.DeserializeComplex(inspectionCenterObject); //JsonConvert.DeserializeObject<ExpandoObject>(s, new CustomJsonSchemaDeserializer());
